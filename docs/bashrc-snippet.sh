...
# so it does NOT fire inside a ttyd-ify web session (wtd sets WT=1). Add to ~/.bashrc:
#
...
# inside a web session would recurse into your multiplexer. ttyd-ify does not edit your
# shell config — copy this yourself if you need it.
